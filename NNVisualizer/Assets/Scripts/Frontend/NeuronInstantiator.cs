...
public class NeuronInstantiator : MonoBehaviour
{
    ...
    public void InstantiateNetwork()
    {
        ...
        // TODO: Update logic to be more generic, and allow for easier updates to transform and rotation
    ...
    void Update()
    {
        ...
        if (elapsedTime >= 10.0f)
        {
            ...
            InstantiateNetwork();
            SendPulses(Generate_Weights(model), Generate_Weights(updatedModel));
